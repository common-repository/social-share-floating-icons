...
function wpafi_plugin_settings_page() {
  ...
  <div>
    ...
    <form method="post" action="options.php">
      ...
      display: block;
      width: 85%;
      text-align: center;" href="https://www.arrowplugins.com/social-floating-icons" 
...
https://www.arrowplugins.com/social-floating-icons" style="margin-left:119px;">Premium Only</a>
            </label>
          </div>
          <div class="control-group" style="width:625px;">
            <label id="wpssfi-enable-plugin" class="control control--checkbox">Show/Hide Social Icons on Home Page:
              <input type="checkbox" name="" value=""/>
              <div id="wpssfi-posts-icons-control" class="control__indicator"></div><a href="
https://www.arrowplugins.com/social-floating-icons" style="margin-left:50px;">Premium Only</a>
            </label>
          </div>
        </div>
            ...
            <div id="wpssfi-floating-position-selection">
              ...
              <div id="wpsssfi-float-right-selection-tab">
                <label for="wpssfi-float-right-cb">
                  <a href="https://www.arrowplugins.com/social-floating-icons" style="margin-left:0;">Premium Only</a>
...
<a href="https://www.arrowplugins.com/social-floating-icons" style="margin-left:0;">Premium Only</a>
        ...
        <div id="wpssfi-themes-settings-tab" >
          <div id="wpssfi-social-icon-themes-selection">
            ...
            <a href="https://www.arrowplugins.com/social-floating-icons" style="margin-left:0;">Premium Only</a><br/>
